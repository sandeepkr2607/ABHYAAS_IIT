        ...
        <Modal isOpen={true}>
            ...
            <ModalContent p={25}>
                ...
                <ModalBody p={15}>
                    <Center>
                        <VStack>
                        <Text fontWeight={'bold'} color={'green.500'} fontSize={'30'}>SUCCESS</Text>
                        <Text fontWeight={'bold'} fontSize={'20'}>Thank You</Text>
                ...
                <Center>
                    <Button colorScheme='orange' size='lg' rounded={'full'} width={'50%'} marginTop={'2%'}>
                        Go to Home Page
                    </Button>
                </Center>
            </ModalContent>
