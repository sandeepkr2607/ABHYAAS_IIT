  ...
  return (
    <div className={css.hero}>
      ...
      <p className={css.para}>
        ...
        coaching center in Motihari, with branches in Raghunathpur and Raja
        Bazar. We nurture students from classes 6th to 12th, empowering them to
        excel in education. Our 14+ IITian Mentors utilize engaging teaching
